      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className="relative grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className="hidden lg:block absolute top-12 border-t border-dashed border-cyan-500/15"
              style={{
                left: `${(i + 1) * 25}%`,
          ...
          {steps.map((s, i) => (
            ...
            >
              <span className="font-mono text-cyan-500/40 text-xs mb-3 block">
                {s.num}
              </span>
              <div className="w-10 h-10 rounded-lg bg-cyan-500/10 flex items-center justify-center mx-auto mb-4">
